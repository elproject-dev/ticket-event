...
export default function MasukPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-xs bg-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-sm mx-auto w-full space-y-8 p-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-bold tracking-tight">Selamat Datang</h1>
          <p className="text-sm text-muted-foreground">
            Masuk ke akun Anda saat ini.<br />
            Dapatkan promo diskon untuk pengguna baru
          </p>
        </div>

        <Button
          onClick={handleGoogleLogin}
          className="w-full rounded-none h-12 text-sm tracking-wide bg-background text-foreground border border-input hover:bg-muted"
        >
